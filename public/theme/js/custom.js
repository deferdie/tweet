...
function clearNotifacations(){
  $('#notifications').mouseenter(function(){
    $.get('/clearnoti', {}, function(data){});});
  //Hide the current set of notifacations
  $('#notifications').mouseleave(function(){$('.noti').hide();updateNotificationCount();});
  //Update the number of notifacations

}

function showNotifacations(){
  $.getJSON('/showNotifacations', { get_param: 'value' }, function(data) {
    $.each(data, function(index, element) {
        $('.noti').append($('<li>', { html: "<a href='"+element.message+"'><span class='icon blue notiIco'><i class='"+element.icon+"'></i></span><span class='message'>"+element.message+"</span><span class='time'>toDo</span></a>"}));
    });
  });
...
function updateNotificationCount(){
  $.get('/getNotificationCount', { get_param: 'value' }, function(data) {
    $('.notCo').html(data);
  });
}
...
function template_functions(){
	...
	var elf = $('.file-manager').elfinder({
		url : 'filemanager/elfinder-connector/connector'  // connector URL (REQUIRED)
	}).elfinder('instance');
