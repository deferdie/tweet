          ...
          <div class="box-content">
              ...
              @foreach($posts as $post)
                  <tr id="row-client-{{$post->id}}">
                      ...
                      <td class="center"> <a href="http://twitter.com/{{App\SocialMediaVault::twitterName($post->clientID)}}" target="_blank">{{App\SocialMediaVault::twitterName($post->clientID)}}</a></td>
                      <td class="center">
                        @if($post->platform == 0)
